package SummarizationReviews.pojo;
 ...
 */
public class ReviewEntity implements Writable {
    Integer reviewCount;
    Float averageRating;
    Float minimumRating;
    Float maximumRating;
    ...
    public ReviewEntity(Integer reviewCount, Float averageRating) {
        this.reviewCount = reviewCount;
        this.averageRating = averageRating;
    }

    public ReviewEntity(Integer reviewCount, Float averageRating, Float minimumRating, Float maximumRating) {
        this.reviewCount = reviewCount;
        this.averageRating = averageRating;
